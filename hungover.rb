...
def start
  ...
  puts "The night before had started as just a few drinks out with friends, but had quickly professed to a somewhat rowdier evening. As you lay there in bed some of the details start trickling back. There had definitely been shots at some point...oh God. So many shots."
  bed_room()
end
